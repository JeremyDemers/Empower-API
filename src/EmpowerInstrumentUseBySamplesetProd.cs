...
{
    public static class EmpowerInstrumentUseBySamplesetProd
    {
        public static List<Dictionary<string, object>> FetchInstrumentsUseBySampleset(string connectionString, DatabaseService databaseService, int year)
        {
